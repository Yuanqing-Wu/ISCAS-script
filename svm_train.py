...
scores = []
i = 0
for c in [800000, 1000000]:
    scores.append([])
    for gamma in [0.0000000005, 0.0000000001, 0.00000000005]:
...
# print(scores)
#feature_train(df_train, df_test, ['w', 'qp', 'nvar', 'H', 'ngradx', 'ngrady', 'ndvarh', 'ndvarv', 'ndgradxh', 'ndgradyh', 'ndgradxv', 'ndgradyv'], save_mode = 'square_64_32_16')
